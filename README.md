# LcAnalyzer
![Continuous Integration build in GitHub Actions](https://github.com/ilicdragana/light-curve-analysis/workflows/CI/badge.svg?branch=main)
